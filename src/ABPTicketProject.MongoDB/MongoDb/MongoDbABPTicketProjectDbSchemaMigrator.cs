...
public class MongoDbABPTicketProjectDbSchemaMigrator : IABPTicketProjectDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbABPTicketProjectDbSchemaMigrator(IServiceProvider serviceProvider)
    {
