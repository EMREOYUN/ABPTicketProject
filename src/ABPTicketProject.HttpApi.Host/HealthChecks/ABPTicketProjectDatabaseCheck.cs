...
public class ABPTicketProjectDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ABPTicketProjectDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
